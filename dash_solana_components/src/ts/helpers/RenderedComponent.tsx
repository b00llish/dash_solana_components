...
import { RenderedComponentProps } from "../props/renderedComponent";

/**
 * RenderedComponent is a generic component for rendering forms.
 *
 * @param {RenderedComponentProps} props - The properties for the component.
 * @returns {JSX.Element} The rendered component.
 */
const RenderedComponent = (props: RenderedComponentProps): JSX.Element => {
    return (
        <form
            onSubmit={(event) => props.method(event)}
