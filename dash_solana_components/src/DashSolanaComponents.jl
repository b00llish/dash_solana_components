...
function __init__()
    ...
    external_url = "https://unpkg.com/dash_solana_components@1.1.0/dash_solana_components/dash_solana_components.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_solana_components@1.1.0/dash_solana_components/dash_solana_components.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
