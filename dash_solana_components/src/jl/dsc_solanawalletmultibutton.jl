...
"""
    ...
    dsc_solanawalletmultibutton(children::Any;kwargs...)
    dsc_solanawalletmultibutton(children_maker::Function;kwargs...)
...
- `endIcon` (optional): . endIcon has the following type: lists containing elements 'type', 'props', 'key'.
...
- `startIcon` (optional): . startIcon has the following type: lists containing elements 'type', 'props', 'key'.
Those elements have the following types:
  - `type` (String; required)
  - `props` (Bool | Real | String | Dict | Array; required)
  - `key` (String; required)
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/table-layout
  - `textAlign` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'end', 'start', 'left', 'right', '-webkit-match-parent', 'justify', 'match-parent'; optional): The **`text-align`** CSS property sets the horizontal alignment of the inline-level content inside a block element or table-cell box. This means it works like `vertical-align` but in the horizontal direction.
...
**Initial value**: `0`
@,deprecated
  - `imeMode` (a value equal to: 'disabled', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'normal', 'active', 'inactive'; optional): The **`ime-mode`** CSS property controls the state of the input method editor (IME) for text fields. This property is obsolete.
...
**Initial value**: `ease`
@,deprecated
  - `MozUserInput` (a value equal to: 'disabled', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none', 'enabled'; optional): In Mozilla applications, **`-moz-user-input`** determines if an element will accept user input.

**Syntax**: `auto | none | enabled | disabled`

**Initial value**: `auto`
@,deprecated
  - `msImeMode` (a value equal to: 'disabled', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'normal', 'active', 'inactive'; optional): The **`ime-mode`** CSS property controls the state of the input method editor (IME) for text fields. This property is obsolete.
...
- `tabIndex` (Real; optional)
"""
function dsc_solanawalletmultibutton(; kwargs...)
        available_props = Symbol[:children, :id, :className, :disabled, :endIcon, :network, :publicKeyState, :rpcEndpoint, :startIcon, :style, :tabIndex]
        wild_props = Symbol[]
...
dsc_solanawalletmultibutton(children::Any; kwargs...) = dsc_solanawalletmultibutton(;kwargs..., children = children)
dsc_solanawalletmultibutton(children_maker::Function; kwargs...) = dsc_solanawalletmultibutton(children_maker(); kwargs...)
